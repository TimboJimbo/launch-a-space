      ...
      <div className="container-custom py-16">
        <div className="max-w-4xl mx-auto prose prose-slate dark:prose-invert">
          ...
          <section className="mb-8">
            ...
            <p>SignUpCodes respects the intellectual property rights of others and expects our users to do the same. It is our policy to respond to clear notices of alleged copyright infringement that comply with the Digital Millennium Copyright Act (DMCA).</p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p>If you believe that the material you posted was removed by mistake or misidentification, you may file a counter-notification with us by providing the following information:</p>
            <ul>
          ...
          <section className="mb-8">
            ...
            <p>This policy is intended to comply with the DMCA and does not constitute legal advice. We recommend consulting with an attorney regarding your rights and obligations under copyright law.</p>
          </section>
        </div>
      </div>
    </div>
