        ...
        <div className="max-w-4xl mx-auto prose prose-slate dark:prose-invert">
          ...
          <section className="mb-8">
            ...
            <ul>
              ...
              <li>Accept cookies through our consent banner</li>
            </ul>
            <p className="mt-4">We automatically collect certain information when you visit our website, including:</p>
            <ul>
          ...
          <section className="mb-8">
            ...
            <p>These cookies are necessary for the website to function and cannot be disabled. They enable core functionality like security, network management, and accessibility.</p>
            
            <h3 className="text-lg font-semibold mt-4 mb-2">Analytics Cookies</h3>
            <p>We use Google Analytics 4 (GA4) to understand how visitors use our site. These cookies collect anonymous information about page views, user interactions, and site performance.</p>
            
            <h3 className="text-lg font-semibold mt-4 mb-2">Advertising Cookies</h3>
            <p>We display advertisements through Google AdSense, which may use cookies to:</p>
            <ul>
            ...
            <h3 className="text-lg font-semibold mt-4 mb-2">Cookie Consent</h3>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4">Affiliate Marketing & Disclosures</h2>
            <p>SignUpCodes participates in affiliate marketing programs, including:</p>
            <ul>
              <li>Amazon Services LLC Associates Program</li>
              <li>Various retailer affiliate programs</li>
              <li>Direct partnerships with brands and merchants</li>
            </ul>
            <p className="mt-2">We may earn commissions from qualifying purchases made through our affiliate links at no additional cost to you. All affiliate relationships are clearly disclosed on our website.</p>
          </section>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4">Your Privacy Rights (GDPR/CCPA)</h2>
          ...
          <section className="mb-8">
            ...
            <p>Your information may be processed and stored in countries other than your own. We ensure appropriate safeguards are in place for international data transfers in compliance with applicable privacy laws.</p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p>We may update this Privacy Policy periodically. We will notify you of any material changes by posting a notice on our website or sending you an email. Your continued use of our services after such changes constitutes acceptance of the updated policy.</p>
          </section>
